				...
				<div className={s.content}>
					...
					<div className={s.more_details}>
						<div className={s.detail}>
							...
							<p className={s.reg}>
								Log transactions, categorize your way, and track spending
								with full control and intent.
							</p>
						</div>
						<div className={s.detail}>
							<p className={s.bold}>Built for customization.</p>
							<p className={s.reg}>
								Create a personalized dashboard to match your unique
								budgeting and financial tracking style.
							</p>
						</div>
						<div className={s.detail}>
							<p className={s.bold}>No ads. No gimmicks. Just clarity.</p>
							<p className={s.reg}>
								No tracking, ads, or upsells—just a clear, distraction-free
