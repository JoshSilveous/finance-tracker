...
import { FormTransaction, PendingChangeUpdater, SortOrder } from '../TransactionManager'
import { MutableRefObject, Dispatch, SetStateAction } from 'react'

export function genHistoryController(
	transactionDataRef: MutableRefObject<FormTransaction[] | null>,
	historyStackRef: MutableRefObject<HistoryState | undefined>,
	setCurSortOrder: Dispatch<SetStateAction<SortOrder>>,
	setHistoryStack: Dispatch<SetStateAction<HistoryState>>,
